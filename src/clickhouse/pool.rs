...
const TRANSACTION_SCHEMA: TableSchema = &[
    ...
    ("fee", "UInt64"),
    ("error_code", "Nullable(Enum8('AccountInUse' = 1, 'AccountLoadedTwice' = 2, 'AccountNotFound' = 3, 'ProgramAccountNotFound' = 4, 'InsufficientFundsForFee' = 5, 'InvalidAccountForFee' = 6, 'AlreadyProcessed' = 7, 'BlockhashNotFound' = 8, 'InstructionError' = 9, 'CallChainTooDeep' = 10, 'MissingSignatureForFee' = 11, 'InvalidAccountIndex' = 12, 'SignatureFailure' = 13, 'InvalidProgramForExecution' = 14, 'SanitizeFailure' = 15, 'ClusterMaintenance' = 16, 'AccountBorrowOutstanding' = 17, 'WouldExceedMaxAccountCostLimit' = 18, 'WouldExceedMaxBlockCostLimit' = 19, 'UnsupportedVersion' = 20, 'InvalidWritableAccount' = 21, 'WouldExceedMaxAccountDataCostLimit' = 22, 'TooManyAccountLocks' = 23, 'AddressLookupTableNotFound' = 24, 'InvalidAddressLookupTableOwner' = 25, 'InvalidAddressLookupTableData' = 26, 'InvalidAddressLookupTableIndex' = 27, 'InvalidRentPayingAccount' = 28, 'WouldExceedMaxVoteCostLimit' = 29, 'WouldExceedAccountDataBlockLimit' = 30, 'WouldExceedAccountDataTotalLimit' = 31, 'DuplicateInstruction' = 32, 'InsufficientFundsForRent' = 33, 'MaxLoadedAccountsDataSizeExceeded' = 34, 'InvalidLoadedAccountsDataSizeLimit' = 35, 'ResanitizationNeeded' = 36, 'UnbalancedTransaction' = 37, 'ProgramExecutionTemporarilyRestricted' = 38, 'ProgramCacheHitMaxLimit' = 39, 'CommitCancelled' = 40))"),
