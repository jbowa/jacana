...
impl crate::workers::ManagedWorker for AccountWorker {
    type Item = Account;
    ...
    fn create(
        ...
        AccountWorker::new(id, pool, arrow_cfg, max_rows, max_bytes, flush_ms)
    }
...
impl AccountManager {
    pub async fn new(
        ...
        let components = crate::workers::build_manager::<AccountWorker>(
            conn_config,
            &batch_cfg.accounts,
            arrow_cfg,
            channel_size,
