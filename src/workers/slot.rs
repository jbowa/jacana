...
impl crate::workers::ManagedWorker for SlotWorker {
    type Item = Slot;
    ...
    fn create(
        ...
        SlotWorker::new(id, pool, arrow_cfg, max_rows, max_bytes, flush_ms)
    }
...
impl SlotManager {
    pub async fn new(
        ...
        let components = crate::workers::build_manager::<SlotWorker>(
            conn_config,
            &batch_cfg.slots,
            arrow_cfg,
            channel_size,
